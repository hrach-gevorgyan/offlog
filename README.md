...
Version 2.6.2 · A local-first task management app built with Svelte 5, PouchDB, and Capacitor. Runs in the browser and as a native Android app. Syncs to CouchDB when available.
...
| Version | Highlights |
|---|---|
| **2.6.2** | Fixed app content (including the sidebar hamburger menu) being hidden under the new status-bar color strip — content now starts below it instead of behind it |
