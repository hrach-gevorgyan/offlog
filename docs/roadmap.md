...
Ordered by what a wrong answer costs, not by effort. Two are done — sync
conflict handling, and the trash/undo/retention lifecycle. Their outcomes,
including what each deliberately does not do, are in
[decisions.md](decisions.md).

1. **Attachments.** Whether the feature is pleasant at all: adding,
...
2. **Recurrence.** The code handles month-end and reminder shifting
...
3. **What degrades over weeks.** The class that caught auto-backup
